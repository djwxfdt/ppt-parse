...
class MFont{
    ...
    constructor(node){
        ...
        let latin = node.getSingle("a:latin")
        if(latin){
            /**
...
class FontScheme{
    ...
    constructor(node){
        ...
        let major = node.getSingle("a:majorFont")
        if(major){
            this.majorFont = new MFont(major)
        }

        let minor = node.getSingle("a:minorFont")
        if(minor){
